      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="../template/dist/img/logoSuplos.png" alt="User Avatar" class="img-size-50 mr-3 img-circle">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="crearUser.php" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../templtate/pages/forms/general.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <div class="col-lg-3 col-6">
           ...
           <div class="small-box bg-success">
              <div class="inner">
                ...
                <p>Historial de eventos registrados</p>
              </div>
              <div class="icon">
